        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <!-- form start -->
              <form action="{{ route('admin.permissions.store') }}" id="quickForm" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="title" placeholder="Enter Permission i-e user-create, user-list">
                        @error('name')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="select2" id="guard" name="guard_name" data-placeholder="Select Guard Name" style="width: 100%;">
