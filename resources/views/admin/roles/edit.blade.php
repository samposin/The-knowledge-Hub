        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <!-- form start -->
              <form action="{{ route('admin.roles.update', $role->id) }}"  id="quickForm" method="post" enctype="multipart/form-data"> 
                @csrf
                @method('PUT')
                @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter Role's Name" value="{{ $role->name }}">
                        @error('name')
